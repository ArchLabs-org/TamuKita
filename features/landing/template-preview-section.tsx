...
function InvitationCard({ theme }: { theme: Theme }) {
  ...
  return (
    <motion.div
      ...
      className="group relative flex-shrink-0 w-56 sm:w-60 cursor-pointer"
    >
      {/* Card shell */}
      <div
      ...
      >
        ...
        <div className="px-6 pb-6 pt-3 text-center">
          ...
          <p
            className="font-sans text-[9px] opacity-40"
            style={{ color: theme.palette.text }}
          >
            {theme.venue}
          </p>
        ...
        <div className="flex justify-center pb-4">
          <svg
            viewBox="0 0 80 40"
            className="w-12 rotate-180 opacity-10"
            fill="none"
          >
            {[0, 60, 120, 180, 240, 300].map((d) => (
              <g key={d} transform={`rotate(${d} 40 40)`}>
...
export function TemplatePreviewSection() {
  ...
  return (
    <Section id="templates" className="bg-warm-50/60 overflow-hidden">
      {/* Header */}
      <div className="mx-auto max-w-2xl text-center">
        ...
        >
          Setiap tema dirancang dengan karakter berbeda — dari minimalis modern hingga
          klasik yang abadi.
        </motion.p>
      </div>
